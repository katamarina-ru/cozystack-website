...
- Добавлена новая функциональность для [резервного копирования](https://cozystack.ru/docs/v1.6/reference/applications/postgres/#backup-parameters) и [восстановления](https://cozystack.ru/docs/v1.6/pplications/postgres/#how-to-restore-backup) в PostgreSQL.
