...
Вся логика платформы теперь строится [вокруг двух CRD](https://cozystack.io/docs/v1.6/guides/concepts/#packagesource-and-package): Package и PackageSource.
...
Теперь у вас есть [два варианта](https://cozystack.io/docs/v1.6/install/cozystack/): 
...
Доступно [подробное руководство](https://cozystack.io/docs/v1.6/operations/upgrades/) по миграции с v0.41 на v1.0. ⚠️ Обратите внимание на [обязательные шаги](https://cozystack.io/docs/v1.6/operations/upgrades/#step-1-protect-critical-resources).
