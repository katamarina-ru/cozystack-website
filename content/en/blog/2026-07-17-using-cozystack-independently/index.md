---
title: "Используете Cozystack самостоятельно?"
slug: using-cozystack-independently
date: 2026-07-17
author: "Тимур Тукаев"
description: "В рамках рассмотрения заявки на инкубацию CNCF, TOC общается с пользователями Cozystack — особенно с командами и отдельными пользователями, работающими с продуктом вне какого-либо коммерческого взаимодействия с Ænix."
images:
...
![Используете Cozystack самостоятельно? Мы ищем независимых пользователей для рассмотрения заявки на инкубацию CNCF.](using-cozystack-independently.png)
