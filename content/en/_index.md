---
title: "Cozystack: Свободная облачная платформа на базе Kubernetes"
description: > 
  Превратите набор bare-metal серверов в интеллектуальную систему с простым REST API для легкого развертывания кластеров Kubernetes, баз данных как услуги (DBaaS), виртуальных машин, балансировщиков нагрузки, сервисов HTTP-кэширования и других служб.
...
<div class="hero-gitops">
  {{% blocks/hero title="Cozystack: Свободная облачная платформа на базе Kubernetes" color="primary"
