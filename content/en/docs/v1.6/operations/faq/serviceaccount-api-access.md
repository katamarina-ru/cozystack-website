...
weight: 20
aliases:
  - /docs/v1.6/operations/api-access
---
...
-   Tenant уже существует в Cozystack.
    Если он еще не создан, см. [Создание пользовательского tenant]({{% ref "/docs/v1.6/getting-started/create-tenant" %}}).
...
Получив токен, вы можете [сгенерировать kubeconfig]({{% ref "/docs/v1.6/operations/faq/generate-kubeconfig" %}}) для доступа через kubectl или использовать токен напрямую через `curl`, как показано ниже.
