...
Это руководство опирается на руководство [Выделенная сеть для LINSTOR]({{% ref "/docs/v1.6/storage/dedicated-network" %}}) и добавляет методы и шаблоны конфигурации, характерные для окружений с несколькими дата-центрами.
...
Инструкции см. в руководстве [Топологические метки узлов]({{% ref "/docs/v1.6/operations/stretched/labels" %}}).
