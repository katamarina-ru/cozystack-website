...
1.  [Установите Talos на узел]({{% ref "/docs/v1.6/install/talos" %}}), используя кастомный образ Talos для Cozystack.

1.  Сгенерируйте конфигурацию для нового узла по руководству [Talm]({{% ref "/docs/v1.6/install/kubernetes/talm#3-generate-node-configuration-files" %}})
    или [talosctl]({{% ref "/docs/v1.6/install/kubernetes/talosctl#2-generate-node-configuration-files" %}}).
...
1.  Примените сгенерированную конфигурацию к узлу по руководству [Talm]({{% ref "/docs/v1.6/install/kubernetes/talm#41-apply-configuration-files" %}})
    или [talosctl]({{% ref "/docs/v1.6/install/kubernetes/talosctl#3-apply-node-configuration" %}}).
    Например:
