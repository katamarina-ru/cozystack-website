...
This is the variant used in the [Build Your Own Platform (BYOP)]({{% ref "/docs/v1.6/install/cozystack/kubernetes-distribution" %}}) workflow.
...
For detailed installation instructions, see the [Generic Kubernetes guide]({{% ref "/docs/v1.6/install/kubernetes/generic" %}}).
...
[configuration reference]({{% ref "/docs/v1.6/operations/configuration" %}}).

To see the full list of components, how to enable and disable them, refer to the
[Components reference]({{% ref "/docs/v1.6/operations/configuration/components" %}}).

To deploy a selected variant, follow the [Cozystack installation guide]({{% ref "/docs/v1.6/install/cozystack" %}})
or [provider-specific guides]({{% ref "/docs/v1.6/install/providers" %}}).
However, if this your first time installing Cozystack, it's best to use the variant `isp-full` and
go through the [Cozystack tutorial]({{% ref "/docs/v1.6/getting-started" %}}).
