...
see the [BYOP (Build Your Own Platform) guide]({{% ref "/docs/v1.6/install/cozystack/kubernetes-distribution" %}}).
{{% /alert %}}
...
-   `spec.variant: "isp-full"` means that we're using the most complete set of Cozystack components.
    Learn more about variants in the [Cozystack Variants reference]({{% ref "/docs/v1.6/operations/configuration/variants" %}}).
...
You can learn more about this configuration file in the [Platform Package reference]({{% ref "/docs/v1.6/operations/configuration/platform-package" %}}).
...
Continue the Cozystack tutorial by [creating a user tenant]({{% ref "/docs/v1.6/getting-started/create-tenant" %}}).
