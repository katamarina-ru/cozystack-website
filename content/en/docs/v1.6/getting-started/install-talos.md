...
Существуют и другие способы [установки Talos Linux для Cozystack]({{% ref "/docs/v1.6/install/talos" %}}), но они здесь не рассматриваются и описаны в отдельных руководствах.
...
-   Прочитайте [обзор Talos Linux]({{% ref "/docs/v1.6/guides/talos" %}}), чтобы понять, почему Talos Linux — оптимальный выбор ОС для Cozystack
    и что он даёт платформе.
-   Узнайте больше о [`boot-to-talos`]({{% ref "/docs/v1.6/install/talos/boot-to-talos#about-the-application" %}}).
