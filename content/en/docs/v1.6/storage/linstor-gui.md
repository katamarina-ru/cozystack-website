...
Add `cozystack.linstor-gui` to `bundles.enabledPackages` in the [Platform Package]({{% ref "/docs/v1.6/operations/configuration/platform-package" %}}):
...
When [OIDC authentication]({{% ref "/docs/v1.6/operations/oidc" %}}) is enabled, you can publish the UI at
