...
Подробнее см. в разделе [Talos Linux]({{% ref "/docs/v1.6/guides/talos" %}}).
...
См. справочник приложения: [TCP Balancer]({{% ref "/docs/v1.6/networking/tcp-balancer" %}})
...
-   [Tenant Kubernetes clusters]({{% ref "/docs/v1.6/kubernetes" %}}) — полнофункциональные managed Kubernetes clusters для development и production workloads.
-   [Managed applications]({{% ref "/docs/v1.6/applications" %}}), например databases и queues.
-   [Virtual machines]({{% ref "/docs/v1.6/virtualization" %}}) с поддержкой Linux и Windows OS.
-   [Networking appliances]({{% ref "/docs/v1.6/networking" %}}), включая VPN, HTTP cache, TCP load balancer и virtual routers.
...
-   Справочник managed application: [Kubernetes]({{% ref "/docs/v1.6/kubernetes" %}})

### Virtual Machines

В Cozystack virtualization features работают на базе [KubeVirt]({{% ref "/docs/v1.6/guides/platform-stack#kubevirt" %}}).
Cozystack предоставляет несколько applications для virtualization functionality:

-   [Virtual machine instance]({{% ref "/docs/v1.6/virtualization/vm-instance" %}}) с более расширенной конфигурацией.
-   [Virtual machine disk]({{% ref "/docs/v1.6/virtualization/vm-disk" %}}) с выбором image sources.
-   [VM image (Golden Disk)]({{% ref "/docs/v1.6/virtualization/vm-image" %}}), который делает OS images локально доступными, ускоряя создание ВМ и экономя network traffic.
...
-   Справочник managed application: [ClickHouse]({{% ref "/docs/v1.6/applications/clickhouse" %}})
...
-   Справочник managed application: [Kafka]({{% ref "/docs/v1.6/applications/kafka" %}})
...
-   Справочник managed application: [MySQL]({{% ref "/docs/v1.6/applications/mariadb" %}})
...
-   Справочник managed application: [NATS]({{% ref "/docs/v1.6/applications/nats" %}})
...
-   Справочник managed application: [PostgreSQL]({{% ref "/docs/v1.6/applications/postgres" %}})
...
-   Справочник managed application: [RabbitMQ]({{% ref "/docs/v1.6/applications/rabbitmq" %}})
...
-   Справочник managed application: [Redis]({{% ref "/docs/v1.6/applications/redis" %}})
...
-   Справочник managed application: [VPN]({{% ref "/docs/v1.6/networking/vpn" %}})
...
-   Справочник managed application: [HTTP Cache]({{% ref "/docs/v1.6/networking/http-cache" %}})
...
-   Справочник managed application: [TCP balancer]({{% ref "/docs/v1.6/networking/tcp-balancer" %}})
-   Docs: [HAProxy Documentation](https://www.haproxy.com/documentation/)

### Tenants

Tenants в Cozystack реализованы как managed applications.
Подробнее о tenants см. в разделе [Tenant System]({{% ref "/docs/v1.6/guides/tenants" %}}).
