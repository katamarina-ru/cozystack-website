...
Подробнее: [Tenant System]({{% ref "/docs/v1.6/guides/tenants" %}}).
...
Подробнее: [tenant Kubernetes clusters]({{% ref "/docs/v1.6/kubernetes" %}}).
...
Подробнее: [managed applications]({{% ref "/docs/v1.6/applications" %}}).
...
Подробнее: [Cozystack API]({{% ref "/docs/v1.6/cozystack-api" %}}).
...
Подробнее: [Variants]({{% ref "/docs/v1.6/operations/configuration/variants" %}}).
