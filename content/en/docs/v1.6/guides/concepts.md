...
Read more: [Tenant System]({{% ref "/docs/v1.6/guides/tenants" %}}).
...
Read more: [tenant Kubernetes clusters]({{% ref "/docs/v1.6/kubernetes" %}}).
...
Read more: [managed applications]({{% ref "/docs/v1.6/applications" %}}).
...
Read more: [Cozystack API]({{% ref "/docs/v1.6/cozystack-api" %}}).
...
Read more: [Variants]({{% ref "/docs/v1.6/operations/configuration/variants" %}}).
