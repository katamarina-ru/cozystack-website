...
Cozystack administrators and users create tenants using the [Tenant application]({{% ref "/docs/v1.6/applications/tenant" %}})
...
Tenants may have [cluster services]({{% ref "/docs/v1.6/operations/services" %}}) deployed in them.
...
- [Tenant Kubernetes cluster]({{% ref "/docs/v1.6/kubernetes" %}}) and a
  [Postgres database]({{% ref "/docs/v1.6/applications/postgres" %}}) in the tenant `bar`.
...
See [Tenant `isolated` flag removed]({{% ref "/docs/v1.6/operations/upgrades#tenant-isolated-flag-removed" %}})
...
[SeaweedFS storage pools]({{% ref "/docs/v1.6/operations/services/object-storage/storage-pools" %}})
...
See the reference for the application implementing tenant management: [`tenant`]({{% ref "/docs/v1.6/applications/tenant#parameters" %}})
