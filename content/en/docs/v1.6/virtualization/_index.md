...
См. справочник по приложению: [`vm-disk`]({{% ref "/docs/v1.6/virtualization/vm-disk" %}}).
...
См. справочник по приложению: [`vm-instance`]({{% ref "/docs/v1.6/virtualization/vm-instance" %}}).
