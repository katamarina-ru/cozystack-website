...
Расширение `velero` приложения [Managed Kubernetes]({{% ref "/docs/v1.6/kubernetes" %}}) устанавливает [Velero](https://velero.io/) внутри tenant-кластера Kubernetes. В связке с tenant [Bucket]({{% ref "/docs/v1.6/operations/services/object-storage/buckets" %}}) оно позволяет пользователям tenant сохранять бэкапы рабочей нагрузки в S3 и затем восстанавливать их.
...
О platform-level Velero, который администраторы кластера используют для для резервного копирования ресурсов ресурсов `VMInstance`/`VMDisk` из management-кластера, см. [Backup Classes]({{% ref "/docs/v1.6/operations/services/backup-classes" %}}).
{{% /alert %}}
...
- SeaweedFS включен для вашего tenant (`spec.seaweedfs: true`). См. [Object Storage]({{% ref "/docs/v1.6/operations/services/object-storage" %}}).
...
<<<<<<< HEAD
- [Управляемый Kubernetes — параметры `addons.velero`]({{% ref "/docs/v1.6/kubernetes#parameters" %}})
- [Пользователи и бакеты]({{% ref "/docs/v1.6/operations/services/object-storage/buckets" %}})
- [Конфигурация Velero Backup (platform admin)]({{% ref "/docs/v1.6/operations/services/velero-backup-configuration" %}})
=======
- [Managed Kubernetes — `addons.velero` parameters]({{% ref "/docs/v1.6/kubernetes#parameters" %}})
- [Buckets and Users]({{% ref "/docs/v1.6/operations/services/object-storage/buckets" %}})
- [Backup Classes (platform admin)]({{% ref "/docs/v1.6/operations/services/backup-classes" %}})
>>>>>>> pr-32
