...
{{% alert color="info" %}}
Это руководство описывает GPU шаринг для **контейнеров в tenant-кластерах Kubernetes**. О пробросе GPU в виртуальные машины на управляемом кластере см. [GPU Passthrough](/docs/v1.6/virtualization/gpu/).
{{% /alert %}}
