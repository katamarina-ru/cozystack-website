...
weight: 25
aliases:
  - /docs/v1.6/operations/talos/installation/oracle-cloud
  - /docs/v1.6/talos/install/oracle-cloud
---
...
[установке самого Cozystack]({{% ref "/docs/v1.6/getting-started/install-cozystack" %}}).
...
[требованиям к кластеру Cozystack]({{% ref "/docs/v1.6/install/hardware-requirements" %}}).
