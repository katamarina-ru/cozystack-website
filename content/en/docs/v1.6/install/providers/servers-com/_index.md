...
weight: 40
aliases:
  - /docs/v1.6/operations/talos/installation/servers_com
  - /docs/v1.6/talos/installation/servers_com
  - /docs/v1.6/talos/install/servers_com
---
...
Теперь для продолжения установки следуйте руководству **Get Started**, начиная с раздела [**Установка Cozystack**]({{% ref "/docs/v1.6/getting-started/install-cozystack" %}}).
