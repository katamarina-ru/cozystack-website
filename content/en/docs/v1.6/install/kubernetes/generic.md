...
- **Оборудование**: см. [требования к оборудованию]({{% ref "/docs/v1.6/install/hardware-requirements" %}})
...
[`networking.kubeovn.MASTER_NODES`]({{% ref "/docs/v1.6/operations/configuration/platform-package" %}})
...
1. [Настройте хранилище с LINSTOR]({{% ref "/docs/v1.6/getting-started/install-cozystack#3-configure-storage" %}})
2. [Настройте root tenant]({{% ref "/docs/v1.6/getting-started/install-cozystack#51-setup-root-tenant-services" %}})
3. [Разверните первое приложение]({{% ref "/docs/v1.6/applications" %}})
