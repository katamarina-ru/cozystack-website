...
For new production deployments, [Talos Linux]({{% ref "/docs/v1.6/guides/talos" %}}) is recommended due to its security and operational benefits.
...
- **Hardware**: See [hardware requirements]({{% ref "/docs/v1.6/install/hardware-requirements" %}})
...
1. [Configure storage with LINSTOR]({{% ref "/docs/v1.6/getting-started/install-cozystack#3-configure-storage" %}})
2. [Set up the root tenant]({{% ref "/docs/v1.6/getting-started/install-cozystack#51-setup-root-tenant-services" %}})
3. [Deploy your first application]({{% ref "/docs/v1.6/applications" %}})
