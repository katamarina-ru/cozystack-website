...
weight: 20
aliases:
  - /docs/v1.6/operations/talos/configuration
  - /docs/v1.6/talos/bootstrap
  - /docs/v1.6/talos/configuration
---
...
Если вы устанавливаете Cozystack впервые, [начните с руководства по Cozystack]({{% ref "/docs/v1.6/getting-started" %}}).

## Варианты установки

### Talos Linux (рекомендуется)

Для production-развертываний Cozystack рекомендует использовать [Talos Linux]({{% ref "/docs/v1.6/guides/talos" %}}) в качестве базовой операционной системы.
Предварительное условие для этих методов — [установленный Talos Linux]({{% ref "/docs/v1.6/install/talos" %}}).
...
-   После установки и настройки кластера Kubernetes можно
    [установить и настроить Cozystack]({{% ref "/docs/v1.6/install/cozystack" %}}).
