...
Эту конфигурацию нужно применить при первом [`talosctl apply`]({{% ref "/docs/v1.6/install/kubernetes/talosctl#3-apply-node-configuration" %}})
или [`talm apply`]({{% ref "/docs/v1.6/install/kubernetes/talm#3-apply-node-configuration" %}})
