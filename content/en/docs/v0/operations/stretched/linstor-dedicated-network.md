...
This guide builds on the [Dedicated Network for LINSTOR]({{% ref "/docs/v0/storage/dedicated-network" %}}) guide,
...
Refer to the [Topology node labels guide]({{% ref "/docs/v0/operations/stretched/labels" %}}) for instructions.
