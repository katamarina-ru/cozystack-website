...
in the [Cozystack ConfigMap]({{% ref "/docs/v0/operations/configuration/configmap" %}}).
...
For example, [installing Cozystack in Hetzner]({{% ref "/docs/v0/install/providers/hetzner" %}})
