...
-   `data.bundle-name: "paas-full"` means that we're using the Cozystack bundle `paas-full`, the most complete set of components.
    Learn more about bundles in the [Cozystack Bundles reference]({{% ref "/docs/v0/operations/configuration/bundles" %}}).
...
You can learn more about this configuration file in the [Cozystack ConfigMap reference]({{% ref "/docs/v0/operations/configuration/configmap" %}}).
...
Continue the Cozystack tutorial by [creating a user tenant]({{% ref "/docs/v0/getting-started/create-tenant" %}}).
