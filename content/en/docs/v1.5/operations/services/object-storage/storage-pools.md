...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.5/operations/services/seaweedfs" %}}) -- full parameter reference
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.5/operations/stretched/seaweedfs-multidc" %}}) -- multi-DC deployment guide
