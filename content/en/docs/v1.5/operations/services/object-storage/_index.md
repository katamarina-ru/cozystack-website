...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.5/operations/services/seaweedfs" %}}) -- auto-generated parameter table for the SeaweedFS package
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.5/operations/stretched/seaweedfs-multidc" %}}) -- deploying SeaweedFS across multiple data centres
