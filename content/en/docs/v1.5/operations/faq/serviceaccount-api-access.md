...
-   A tenant already exists in Cozystack.
    See [Create a User Tenant]({{% ref "/docs/v1.5/getting-started/create-tenant" %}}) if you haven't created one yet.
...
Once you have the token, you can [generate a kubeconfig]({{% ref "/docs/v1.5/operations/faq/generate-kubeconfig" %}}) for kubectl access, or use it directly with `curl` as shown below.
