...
This guide builds on the [Dedicated Network for LINSTOR]({{% ref "/docs/v1.5/storage/dedicated-network" %}}) guide,
...
Refer to the [Topology node labels guide]({{% ref "/docs/v1.5/operations/stretched/labels" %}}) for instructions.
