...
- [Backup Classes]({{% ref "/docs/v1.5/operations/services/backup-classes" %}}) — how administrators define strategies and `BackupClass` resources.
...
- [Backup Classes]({{% ref "/docs/v1.5/operations/services/backup-classes" %}}) — administrator setup for the Velero-driven VM backups.
