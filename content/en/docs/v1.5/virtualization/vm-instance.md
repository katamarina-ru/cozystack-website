...
aliases:
  ...
  - /docs/v1.5/reference/applications/vm-instance
---

<!--
Автоматически сгенерированное содержимое. Не редактируйте этот файл напрямую; редактируйте исходные файлы.
metadata: https://github.com/cozystack/website/blob/main/content/en/docs/v1.5/virtualization/_include/vm-instance.md
source: https://github.com/cozystack/cozystack/blob/release-1.5/packages/apps/vm-instance/README.md
-->
