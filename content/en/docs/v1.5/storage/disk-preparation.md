...
Если для развёртывания кластера вы использовали [Talm]({{% ref "/docs/v1.5/install/kubernetes/talm" %}}), конфигурации узлов хранятся в файлах `nodes/*.yaml` в каталоге конфигурации кластера.
...
- [Развёртывание Cozystack с помощью Talm]({{% ref "/docs/v1.5/install/kubernetes/talm" %}})
- [Настройка выделенной сети для LINSTOR]({{% ref "/docs/v1.5/storage/dedicated-network" %}})
- [Настройка контроллера ресинхронизации DRBD]({{% ref "/docs/v1.5/storage/drbd-tuning" %}})
- [Устранение неполадок LINSTOR]({{% ref "/docs/v1.5/operations/troubleshooting/linstor-controller" %}})
