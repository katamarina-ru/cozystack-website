...
weight: 40
aliases:
  - /docs/v1.5/operations/storage/linstor-gui
---
...
Добавьте `cozystack.linstor-gui` в `bundles.enabledPackages` в [Platform Package]({{% ref "/docs/v1.5/operations/configuration/platform-package" %}}):
...
Если включена [аутентификация OIDC]({{% ref "/docs/v1.5/operations/oidc" %}}), интерфейс можно опубликовать по адресу
