...
{{% alert color="info" %}}
This guide covers GPU sharing for **containers in tenant Kubernetes clusters**. For GPU passthrough to virtual machines on the management cluster, see [GPU Passthrough](/docs/v1.5/virtualization/gpu/).
{{% /alert %}}
