...
Read more: [Tenant System]({{% ref "/docs/v1.5/guides/tenants" %}}).
...
Read more: [tenant Kubernetes clusters]({{% ref "/docs/v1.5/kubernetes" %}}).
...
Read more: [managed applications]({{% ref "/docs/v1.5/applications" %}}).
...
Read more: [Cozystack API]({{% ref "/docs/v1.5/cozystack-api" %}}).
...
Read more: [Variants]({{% ref "/docs/v1.5/operations/configuration/variants" %}}).
