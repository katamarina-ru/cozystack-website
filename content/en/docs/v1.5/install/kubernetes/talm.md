...
By the start of this guide you should have [Talos Linux installed]({{% ref "/docs/v1.5/install/talos" %}}), but not initialized (bootstrapped), on several nodes.
...
[Configure bonding (LACP)]({{% ref "/docs/v1.5/install/how-to/bonding" %}}).
...
[Install Cozystack]({{% ref "/docs/v1.5/getting-started/install-cozystack" %}}) section.
