...
This configuration must be applied with the first [`talosctl apply`]({{% ref "/docs/v1.5/install/kubernetes/talosctl#3-apply-node-configuration" %}})
or [`talm apply`]({{% ref "/docs/v1.5/install/kubernetes/talm#3-apply-node-configuration" %}})
