...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.2/operations/services/seaweedfs" %}}) -- auto-generated parameter table for the SeaweedFS package
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.2/operations/stretched/seaweedfs-multidc" %}}) -- deploying SeaweedFS across multiple data centres
