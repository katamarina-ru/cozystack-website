...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.2/operations/services/seaweedfs" %}}) -- full parameter reference
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.2/operations/stretched/seaweedfs-multidc" %}}) -- multi-DC deployment guide
