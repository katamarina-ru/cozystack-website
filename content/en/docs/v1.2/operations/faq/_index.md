...
Deploying Cozystack, [How to install Talos on a single-disk machine]({{% ref "/docs/v1.2/install/how-to/single-disk" %}})
...
Deploying Cozystack, [How to Enable KubeSpan]({{% ref "/docs/v1.2/install/how-to/kubespan" %}})
...
Deploying Cozystack, [How to enable Hugepages]({{% ref "/docs/v1.2/install/how-to/hugepages" %}}).
...
For deploying on Hetzner, follow the specialized [Hetzner installation guide]({{% ref "/docs/v1.2/install/providers/hetzner" %}}).
For other providers, follow the [Cozystack installation guide, Public IP Setup]({{% ref "/docs/v1.2/install/cozystack#4b-public-ip-setup" %}}).
...
Deploying Cozystack, [Deploy with public networks]({{% ref "/docs/v1.2/install/how-to/public-ip" %}}).
...
Moved to [How to generate kubeconfig for tenant users]({{% ref "/docs/v1.2/operations/faq/generate-kubeconfig" %}}).
...
See [ServiceAccount Tokens for API Access]({{% ref "/docs/v1.2/operations/faq/serviceaccount-api-access" %}}).
...
Moved to Cluster Maintenance, [How to Rotate Certificate Authority]({{% ref "/docs/v1.2/operations/cluster/rotate-ca" %}}).
...
Moved to Troubleshooting: [How to clean up etcd state]({{% ref "/docs/v1.2/operations/troubleshooting/etcd#how-to-clean-up-etcd-state" %}}).
...
Moved to Cluster configuration, [Components reference]({{% ref "/docs/v1.2/operations/configuration/components#overwriting-component-parameters" %}}).
...
Moved to Cluster configuration, [Components reference]({{% ref "/docs/v1.2/operations/configuration/components#enabling-and-disabling-components" %}}).
