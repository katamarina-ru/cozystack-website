...
weight: 30
aliases:
  - /docs/v1.2/use-cases/kubernetes-distribution
---
...
For a step-by-step guide, see the [BYOP installation guide]({{% ref "/docs/v1.2/install/cozystack/kubernetes-distribution" %}}).
