...
weight: 10
aliases:
  - /docs/v1.2/operations/storage/dedicated-network
---
...
See the example in
[Multi Datacenter dedicated storage network guide]({{% ref "/docs/v1.2/operations/stretched/linstor-dedicated-network" %}})
