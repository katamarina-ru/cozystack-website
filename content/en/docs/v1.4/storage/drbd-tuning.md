...
Для конфигурации с несколькими дата-центрами также прочитайте руководство [Настройка DRBD для нескольких дата-центров]({{% ref "/docs/v1.4/operations/stretched/drbd-tuning" %}}).
