...
Установите и выполните bootstrap кластера Kubernetes с помощью [Talm]({{% ref "/docs/v1.4/install/kubernetes/talm" %}}) — декларативного CLI-инструмента управления конфигурацией с готовыми пресетами для Cozystack.
