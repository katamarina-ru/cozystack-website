...
weight: 20
aliases:
  - /docs/v1.4/guides/bundles
  - /docs/v1.4/operations/bundles/
  - /docs/v1.4/operations/bundles/isp-full
  - /docs/v1.4/operations/bundles/isp-hosted
  - /docs/v1.4/operations/bundles/paas-full
  - /docs/v1.4/operations/bundles/paas-hosted
  - /docs/v1.4/operations/bundles/distro-full
  - /docs/v1.4/operations/bundles/distro-hosted
  - /docs/v1.4/install/cozystack/bundles
  - /docs/v1.4/operations/configuration/bundles
---
...
[apps]: {{% ref "/docs/v1.4/applications" %}}
[vm]: {{% ref "/docs/v1.4/virtualization" %}}
[k8s]: {{% ref "/docs/v1.4/kubernetes" %}}
[api]: {{% ref "/docs/v1.4/cozystack-api" %}}
[monitoring subsystem]: {{% ref "/docs/v1.4/guides/platform-stack#victoria-metrics" %}}
[linstor]: {{% ref "/docs/v1.4/guides/platform-stack#drbd" %}}
[kube-ovn]: {{% ref "/docs/v1.4/guides/platform-stack#kube-ovn" %}}
[cilium]: {{% ref "/docs/v1.4/guides/platform-stack#cilium" %}}
[kubevirt]: {{% ref "/docs/v1.4/guides/platform-stack#kubevirt" %}}
[talos linux]: {{% ref "/docs/v1.4/guides/platform-stack#talos-linux" %}}
[kubernetes]: {{% ref "/docs/v1.4/guides/platform-stack#kubernetes" %}}
[kubernetes operators]: https://github.com/cozystack/cozystack/blob/main/packages/core/platform/templates/bundles/paas.yaml

[default]: {{% ref "/docs/v1.4/operations/configuration/variants#default" %}}
[isp-full]: {{% ref "/docs/v1.4/operations/configuration/variants#isp-full" %}}
[isp-full-generic]: {{% ref "/docs/v1.4/operations/configuration/variants#isp-full-generic" %}}
[isp-hosted]: {{% ref "/docs/v1.4/operations/configuration/variants#isp-hosted" %}}
...
Именно этот вариант используется в workflow [Build Your Own Platform (BYOP)]({{% ref "/docs/v1.4/install/cozystack/kubernetes-distribution" %}}).
...
Подробные инструкции по установке см. в [руководстве Generic Kubernetes]({{% ref "/docs/v1.4/install/kubernetes/generic" %}}).
...
[справочнике по конфигурации]({{% ref "/docs/v1.4/operations/configuration" %}}).

Полный список компонентов и инструкции по их включению и отключению см. в
[справочнике компонентов]({{% ref "/docs/v1.4/operations/configuration/components" %}}).

Чтобы развернуть выбранный вариант, следуйте [руководству по установке Cozystack]({{% ref "/docs/v1.4/install/cozystack" %}})
или [руководствам для конкретных провайдеров]({{% ref "/docs/v1.4/install/providers" %}}).
Если вы устанавливаете Cozystack впервые, лучше использовать вариант `isp-full` и пройти [tutorial Cozystack]({{% ref "/docs/v1.4/getting-started" %}}).
