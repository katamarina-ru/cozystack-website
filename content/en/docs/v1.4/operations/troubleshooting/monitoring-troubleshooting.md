...
For more details, see [Monitoring Setup]({{% ref "/docs/v1.4/operations/services/monitoring/setup" %}}).
...
See [Monitoring Alerting]({{% ref "/docs/v1.4/operations/services/monitoring/alerting" %}}) for configuration details.
...
Refer to [Monitoring Dashboards]({{% ref "/docs/v1.4/operations/services/monitoring/dashboards" %}}) for dashboard setup.
...
For more information, see [Monitoring Logs]({{% ref "/docs/v1.4/operations/services/monitoring/logs" %}}).