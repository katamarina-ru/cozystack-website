...
Подробную конфигурацию см. в [справочнике Monitoring Hub]({{% ref "/docs/v1.4/operations/services/monitoring" %}}).
...
Подробнее о механизме sharing services см. в [Tenant System]({{% ref "/docs/v1.4/guides/tenants#sharing-cluster-services" %}})
