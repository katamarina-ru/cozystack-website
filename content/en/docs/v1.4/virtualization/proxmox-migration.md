...
- Configure [cloud-init]({{% ref "/docs/v1.4/virtualization/vm-instance" %}}) for automated VM setup
- Review [instance types and profiles]({{% ref "/docs/v1.4/virtualization/resources" %}}) for optimal resource allocation
- Consider creating [golden images]({{% ref "/docs/v1.4/virtualization/vm-image" %}}) for future VM deployments
