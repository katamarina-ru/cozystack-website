...
weight: 20
aliases:
  - /docs/v1.4/operations/talos/configuration/air-gapped
  - /docs/v1.4/talos/bootstrap/air-gapped
---
...
Read the [Talm configuration guide]({{% ref "/docs/v1.4/install/kubernetes/talm" %}}) to learn more.
...
Read the [`talosctl` configuration guide]({{% ref "/docs/v1.4/install/kubernetes/talosctl" %}}) to learn more.
