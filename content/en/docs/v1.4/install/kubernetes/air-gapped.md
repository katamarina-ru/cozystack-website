...
Подробнее см. в [руководстве по настройке Talm]({{% ref "/docs/v1.4/install/kubernetes/talm" %}}).
...
Подробнее см. в [руководстве по настройке `talosctl`]({{% ref "/docs/v1.4/install/kubernetes/talosctl" %}}).
