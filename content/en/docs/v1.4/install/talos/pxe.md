...
weight: 15
aliases:
  - /docs/v1.4/talos/installation/pxe
  - /docs/v1.4/talos/install/pxe
  - /docs/v1.4/operations/talos/installation/pxe
---
...
Once you have installed Talos, proceed by [installing and bootstrapping a Kubernetes cluster]({{% ref "/docs/v1.4/install/kubernetes" %}}).
