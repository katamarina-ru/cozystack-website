...
It can be used by a single company to run its own [private cloud]({{% ref "/docs/v1.4/guides/use-cases/private-cloud" %}}) or by a service provider to offer a
[platform-as-a-service]({{% ref "/docs/v1.4/guides/use-cases/public-cloud" %}}) to multiple customers.

Cozystack covers the most critical needs of a development team:

-   [Kubernetes clusters]({{% ref "/docs/v1.4/cozystack-api" %}}) for running applications in development and production
-   Standard [managed applications]({{% ref "/docs/v1.4/applications" %}}): databases, queue managers, caches, and more
-   [Virtual machines]({{% ref "/docs/v1.4/virtualization" %}})
-   Reliable distributed storage

[Cozystack platform stack]({{% ref "/docs/v1.4/guides/platform-stack" %}}) includes reliable components that are typically installed
...
Another powerful feature is the [tenant system]({{% ref "/docs/v1.4/guides/concepts#tenant-system" %}}).
...
Cozystack's [tenant system]({{% ref "/docs/v1.4/guides/concepts#tenant-system" %}}) solves these issues
...
The [single sign-on system]({{% ref "/docs/v1.4/operations/oidc" %}}) in Cozystack is powered by Keycloak.
...
In Cozystack, [virtual machines]({{% ref "/docs/v1.4/virtualization" %}})
...
Cozystack avoids this by running [managed databases]({{% ref "/docs/v1.4/applications" %}})
...
a [Cozystack variant]({{% ref "/docs/v1.4/operations/configuration/variants" %}}) that fits your needs.
