...
Он может использоваться отдельной компанией для запуска собственного [частного облака]({{% ref "/docs/v1.3/guides/use-cases/private-cloud" %}}) или поставщиком услуг для предоставления
[платформы как услуги]({{% ref "/docs/v1.3/guides/use-cases/public-cloud" %}}) нескольким клиентам.

Cozystack закрывает наиболее важные потребности команды разработчиков:

-   [Кластеры Kubernetes]({{% ref "/docs/v1.3/cozystack-api" %}}) для запуска приложений в среде разработки и в продакшене
-   Стандартные [управляемые приложения]({{% ref "/docs/v1.3/applications" %}}) : базы данных, менеджеры очередей, кэши и многое другое
-   [Виртуальные машины]({{% ref "/docs/v1.3/virtualization" %}}) 
-   Надёжное распределённое хранилище

[Платформенный стек Cozystack]({{% ref "/docs/v1.3/guides/platform-stack" %}}) включает надёжные компоненты, которые обычно устанавливаются
...
Ещё одна мощная функция — [система тенантов]({{% ref "/docs/v1.3/guides/concepts#tenant-system" %}}).
...
[Система тенантов]({{% ref "/docs/v1.3/guides/concepts#tenant-system" %}}) Cozystack решает эти проблемы,
...
[Система единого входа]({{% ref "/docs/v1.3/operations/oidc" %}}) в Cozystack работает на базе Keycloak.
...
В Cozystack [виртуальные машины]({{% ref "/docs/v1.3/virtualization" %}})
...
Cozystack избегает этого, запуская [управляемые базы данных]({{% ref "/docs/v1.3/applications" %}})
...
[вариант Cozystack]({{% ref "/docs/v1.3/operations/configuration/variants" %}}), подходящий для ваших нужд.
