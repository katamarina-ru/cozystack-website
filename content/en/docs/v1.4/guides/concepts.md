...
Подробнее: [Tenant System]({{% ref "/docs/v1.4/guides/tenants" %}}).
...
Подробнее: [tenant Kubernetes clusters]({{% ref "/docs/v1.4/kubernetes" %}}).
...
Подробнее: [managed applications]({{% ref "/docs/v1.4/applications" %}}).
...
Подробнее: [Cozystack API]({{% ref "/docs/v1.4/cozystack-api" %}}).
...
Подробнее: [Variants]({{% ref "/docs/v1.4/operations/configuration/variants" %}}).
