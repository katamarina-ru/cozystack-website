...
Read more: [Tenant System]({{% ref "/docs/v1.4/guides/tenants" %}}).
...
Read more: [tenant Kubernetes clusters]({{% ref "/docs/v1.4/kubernetes" %}}).
...
Read more: [managed applications]({{% ref "/docs/v1.4/applications" %}}).
...
Read more: [Cozystack API]({{% ref "/docs/v1.4/cozystack-api" %}}).
...
Read more: [Variants]({{% ref "/docs/v1.4/operations/configuration/variants" %}}).
