...
-   There are [other installation methods]({{% ref "/docs/v1.0/install/talos" %}}) which require either any Linux or no OS at all to start.
...
For a more detailed explanation of hardware requirements for different setups, refer to the [Hardware Requirements]({{% ref "/docs/v1.0/install/hardware-requirements" %}})
