...
weight: 50
aliases:
  - /docs/v1.0/operations/virtualization
  - /docs/v1.0/operations/virtualization/virtual-machines
---
...
See the application reference: [`vm-disk`]({{% ref "/docs/v1.0/virtualization/vm-disk" %}}).
...
See the application reference: [`vm-instance`]({{% ref "/docs/v1.0/virtualization/vm-instance" %}}).
