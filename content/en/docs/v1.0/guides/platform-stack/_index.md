...
Read more about it in the [Talos Linux]({{% ref "/docs/v1.0/guides/talos" %}}) section.
...
See the application reference: [TCP Balancer]({{% ref "/docs/v1.0/networking/tcp-balancer" %}})
...
-   [Tenant Kubernetes clusters]({{% ref "/docs/v1.0/kubernetes" %}}), fully-functional managed Kubernetes clusters for development and production workloads.
-   [Managed applications]({{% ref "/docs/v1.0/applications" %}}), such as databases and queues.
-   [Virtual machines]({{% ref "/docs/v1.0/virtualization" %}}), supporting Linux and Windows OS.
-   [Networking appliances]({{% ref "/docs/v1.0/networking" %}}), including VPN, HTTP cache, TCP load balancer, and virtual routers.
...
-   Managed application reference: [Kubernetes]({{% ref "/docs/v1.0/kubernetes" %}})


### Virtual Machines

In Cozystack, virtualization features are powered by [KubeVirt]({{% ref "/docs/v1.0/guides/platform-stack#kubevirt" %}}).
Cozystack has a number of applications providing virtualization functionality:

-   [Virtual machine instance]({{% ref "/docs/v1.0/virtualization/vm-instance" %}}) with more advanced configuration.
-   [Virtual machine disk]({{% ref "/docs/v1.0/virtualization/vm-disk" %}}), offering a choice of image sources.
-   [VM image (Golden Disk)]({{% ref "/docs/v1.0/virtualization/vm-image" %}}), which makes OS images locally available, improving VM creation time and saving network traffic.
...
-   Managed application reference: [ClickHouse]({{% ref "/docs/v1.0/applications/clickhouse" %}})
...
-   Managed application reference: [Kafka]({{% ref "/docs/v1.0/applications/kafka" %}})
...
-   Managed application reference: [MySQL]({{% ref "/docs/v1.0/applications/mariadb" %}})
...
-   Managed application reference: [NATS]({{% ref "/docs/v1.0/applications/nats" %}})
...
-   Managed application reference: [PostgreSQL]({{% ref "/docs/v1.0/applications/postgres" %}})
...
-   Managed application reference: [RabbitMQ]({{% ref "/docs/v1.0/applications/rabbitmq" %}})
...
-   Managed application reference: [Redis]({{% ref "/docs/v1.0/applications/redis" %}})
...
-   Managed application reference: [VPN]({{% ref "/docs/v1.0/networking/vpn" %}})
...
-   Managed application reference: [HTTP Cache]({{% ref "/docs/v1.0/networking/http-cache" %}})
...
-   Managed application reference: [TCP balancer]({{% ref "/docs/v1.0/networking/tcp-balancer" %}})
...
Learn more about tenants in [Tenant System]({{% ref "/docs/v1.0/guides/tenants" %}}).
