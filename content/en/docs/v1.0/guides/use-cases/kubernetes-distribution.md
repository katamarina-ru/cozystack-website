...
weight: 30
aliases:
  - /docs/v1.0/use-cases/kubernetes-distribution
---
...
For a step-by-step guide, see the [BYOP installation guide]({{% ref "/docs/v1.0/install/cozystack/kubernetes-distribution" %}}).
