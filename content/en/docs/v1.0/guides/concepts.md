...
Read more: [Tenant System]({{% ref "/docs/v1.0/guides/tenants" %}}).
...
Read more: [tenant Kubernetes clusters]({{% ref "/docs/v1.0/kubernetes" %}}).
...
Read more: [managed applications]({{% ref "/docs/v1.0/applications" %}}).
...
Read more: [Cozystack API]({{% ref "/docs/v1.0/cozystack-api" %}}).
...
Read more: [Variants]({{% ref "/docs/v1.0/operations/configuration/variants" %}}).
