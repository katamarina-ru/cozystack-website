...
weight: 100
aliases:
  - /docs/v1.0/operations/faq/single-disk-installation
---
...
This configuration must be applied with the first [`talosctl apply`]({{% ref "/docs/v1.0/install/kubernetes/talosctl#3-apply-node-configuration" %}})
or [`talm apply`]({{% ref "/docs/v1.0/install/kubernetes/talm#3-apply-node-configuration" %}})
