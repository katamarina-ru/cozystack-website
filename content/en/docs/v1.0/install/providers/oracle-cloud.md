...
weight: 25
aliases:
  - /docs/v1.0/operations/talos/installation/oracle-cloud
  - /docs/v1.0/talos/install/oracle-cloud
---
...
[installing Cozystack itself]({{% ref "/docs/v1.0/getting-started/install-cozystack" %}}).
...
[Cozystack cluster requirements]({{% ref "/docs/v1.0/install/hardware-requirements" %}}).
