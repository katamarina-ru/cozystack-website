...
weight: 15
aliases:
  - /docs/v1.0/talos/installation/pxe
  - /docs/v1.0/talos/install/pxe
  - /docs/v1.0/operations/talos/installation/pxe
---
...
Once you have installed Talos, proceed by [installing and bootstrapping a Kubernetes cluster]({{% ref "/docs/v1.0/install/kubernetes" %}}).
