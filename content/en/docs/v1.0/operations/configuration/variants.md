...
weight: 20
aliases:
  - /docs/v1.0/guides/bundles
  - /docs/v1.0/operations/bundles/
  - /docs/v1.0/operations/bundles/isp-full
  - /docs/v1.0/operations/bundles/isp-hosted
  - /docs/v1.0/operations/bundles/paas-full
  - /docs/v1.0/operations/bundles/paas-hosted
  - /docs/v1.0/operations/bundles/distro-full
  - /docs/v1.0/operations/bundles/distro-hosted
  - /docs/v1.0/install/cozystack/bundles
  - /docs/v1.0/operations/configuration/bundles
---
...
[apps]: {{% ref "/docs/v1.0/applications" %}}
[vm]: {{% ref "/docs/v1.0/virtualization" %}}
[k8s]: {{% ref "/docs/v1.0/kubernetes" %}}
[api]: {{% ref "/docs/v1.0/cozystack-api" %}}
[monitoring subsystem]: {{% ref "/docs/v1.0/guides/platform-stack#victoria-metrics" %}}
[linstor]: {{% ref "/docs/v1.0/guides/platform-stack#drbd" %}}
[kube-ovn]: {{% ref "/docs/v1.0/guides/platform-stack#kube-ovn" %}}
[cilium]: {{% ref "/docs/v1.0/guides/platform-stack#cilium" %}}
[kubevirt]: {{% ref "/docs/v1.0/guides/platform-stack#kubevirt" %}}
[talos linux]: {{% ref "/docs/v1.0/guides/platform-stack#talos-linux" %}}
[kubernetes]: {{% ref "/docs/v1.0/guides/platform-stack#kubernetes" %}}
[kubernetes operators]: https://github.com/cozystack/cozystack/blob/main/packages/core/platform/templates/bundles/paas.yaml

[default]: {{% ref "/docs/v1.0/operations/configuration/variants#default" %}}
[isp-full]: {{% ref "/docs/v1.0/operations/configuration/variants#isp-full" %}}
[isp-full-generic]: {{% ref "/docs/v1.0/operations/configuration/variants#isp-full-generic" %}}
[isp-hosted]: {{% ref "/docs/v1.0/operations/configuration/variants#isp-hosted" %}}
...
This is the variant used in the [Build Your Own Platform (BYOP)]({{% ref "/docs/v1.0/install/cozystack/kubernetes-distribution" %}}) workflow.
...
For detailed installation instructions, see the [Generic Kubernetes guide]({{% ref "/docs/v1.0/install/kubernetes/generic" %}}).
...
[configuration reference]({{% ref "/docs/v1.0/operations/configuration" %}}).

To see the full list of components, how to enable and disable them, refer to the
[Components reference]({{% ref "/docs/v1.0/operations/configuration/components" %}}).

To deploy a selected variant, follow the [Cozystack installation guide]({{% ref "/docs/v1.0/install/cozystack" %}})
or [provider-specific guides]({{% ref "/docs/v1.0/install/providers" %}}).
However, if this your first time installing Cozystack, it's best to use the variant `isp-full` and
go through the [Cozystack tutorial]({{% ref "/docs/v1.0/getting-started" %}}).
