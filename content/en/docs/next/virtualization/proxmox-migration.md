...
- Configure [cloud-init]({{% ref "/docs/next/virtualization/vm-instance" %}}) for automated VM setup
- Review [instance types and profiles]({{% ref "/docs/next/virtualization/resources" %}}) for optimal resource allocation
- Consider creating [golden images]({{% ref "/docs/next/virtualization/vm-image" %}}) for future VM deployments
