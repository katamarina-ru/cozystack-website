...
For more details, see [Monitoring Setup]({{% ref "/docs/next/operations/services/monitoring/setup" %}}).
...
See [Monitoring Alerting]({{% ref "/docs/next/operations/services/monitoring/alerting" %}}) for configuration details.
...
Refer to [Monitoring Dashboards]({{% ref "/docs/next/operations/services/monitoring/dashboards" %}}) for dashboard setup.
...
For more information, see [Monitoring Logs]({{% ref "/docs/next/operations/services/monitoring/logs" %}}).