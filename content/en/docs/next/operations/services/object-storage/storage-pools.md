...
- [SeaweedFS Service Reference]({{% ref "/docs/next/operations/services/seaweedfs" %}}) -- full parameter reference
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/next/operations/stretched/seaweedfs-multidc" %}}) -- multi-DC deployment guide
