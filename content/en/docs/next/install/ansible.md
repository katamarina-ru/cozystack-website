...
For manual installation steps without Ansible, see the [Generic Kubernetes]({{% ref "/docs/next/install/kubernetes/generic" %}}) guide.
...
- See [hardware requirements]({{% ref "/docs/next/install/hardware-requirements" %}}) for CPU, RAM, and disk sizing
