...
weight: 40
aliases:
  - /docs/next/operations/talos/installation/servers_com
  - /docs/next/talos/installation/servers_com
  - /docs/next/talos/install/servers_com
---
...
Now follow **Get Started** guide starting from the [**Install Cozystack**]({{% ref "/docs/next/getting-started/install-cozystack" %}}) section, to continue the installation.
