...
weight: 25
aliases:
  - /docs/next/operations/talos/installation/oracle-cloud
  - /docs/next/talos/install/oracle-cloud
---
...
[installing Cozystack itself]({{% ref "/docs/next/getting-started/install-cozystack" %}}).
...
[Cozystack cluster requirements]({{% ref "/docs/next/install/hardware-requirements" %}}).
