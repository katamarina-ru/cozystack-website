...
-   Learn about [Cozystack variants]({{% ref "/docs/next/operations/configuration/variants" %}}) and how they define package composition.
-   See the [Components reference]({{% ref "/docs/next/operations/configuration/components" %}}) for details on overriding component parameters.
