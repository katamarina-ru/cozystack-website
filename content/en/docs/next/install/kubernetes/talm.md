...
weight: 5
aliases:
  - /docs/next/operations/talos/configuration/talm
  - /docs/next/talos/bootstrap/talm
  - /docs/next/talos/configuration/talm
---
...
By the start of this guide you should have [Talos Linux installed]({{% ref "/docs/next/install/talos" %}}), but not initialized (bootstrapped), on several nodes.
...
[Configure bonding (LACP)]({{% ref "/docs/next/install/how-to/bonding" %}}).
...
[Install Cozystack]({{% ref "/docs/next/getting-started/install-cozystack" %}}) section.
