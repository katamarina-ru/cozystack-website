...
If this is your first time installing Cozystack, consider [going through the Cozystack tutorial]({{% ref "/docs/next/getting-started" %}}).
...
For generic Linux deployments (Ubuntu, Debian, RHEL, Rocky, openSUSE), the [Ansible collection]({{% ref "/docs/next/install/ansible" %}}) automates the full pipeline: OS preparation, k3s cluster bootstrap, and Cozystack installation.
...
- [Hetzner]({{% ref "/docs/next/install/providers/hetzner" %}})
- [Oracle Cloud Infrastructure (OCI)]({{% ref "/docs/next/install/providers/oracle-cloud" %}})
- [Servers.com]({{% ref "/docs/next/install/providers/servers-com" %}})


## Upgrading and Post-deployment Configuration

After you've deployed a cluster, proceed to the [Cluster Administration]({{% ref "/docs/next/operations" %}}) section for
the next actions:

- [Configure OIDC]({{% ref "/docs/next/operations/oidc" %}})
- [Deploy Cozystack in a Multi-Datacenter Setup]({{% ref "/docs/next/operations/stretched" %}})
- [Upgrading Cozystack]({{% ref "/docs/next/operations/cluster/upgrade" %}})
