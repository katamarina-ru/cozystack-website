...
weight: 20
aliases:
  - /docs/v1.1/operations/talos/configuration
  - /docs/v1.1/talos/bootstrap
  - /docs/v1.1/talos/configuration
---
...
If this is your first time installing Cozystack, [start with the Cozystack tutorial]({{% ref "/docs/v1.1/getting-started" %}}).

## Installation Options

### Talos Linux (Recommended)

For production deployments, Cozystack recommends [Talos Linux]({{% ref "/docs/v1.1/guides/talos" %}}) as the underlying operating system.
A prerequisite to using these methods is having [installed Talos Linux]({{% ref "/docs/v1.1/install/talos" %}}).
...
-   After installing and configuring a Kubernetes cluster, you are ready to
    [install and configure Cozystack]({{% ref "/docs/v1.1/install/cozystack" %}}).
