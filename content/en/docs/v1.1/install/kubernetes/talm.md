...
weight: 5
aliases:
  - /docs/v1.1/operations/talos/configuration/talm
  - /docs/v1.1/talos/bootstrap/talm
  - /docs/v1.1/talos/configuration/talm
---
...
By the start of this guide you should have [Talos Linux installed]({{% ref "/docs/v1.1/install/talos" %}}), but not initialized (bootstrapped), on several nodes.
...
[Configure bonding (LACP)]({{% ref "/docs/v1.1/install/how-to/bonding" %}}).
...
[Install Cozystack]({{% ref "/docs/v1.1/getting-started/install-cozystack" %}}) section.
