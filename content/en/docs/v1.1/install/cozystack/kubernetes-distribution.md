...
-   Learn about [Cozystack variants]({{% ref "/docs/v1.1/operations/configuration/variants" %}}) and how they define package composition.
-   See the [Components reference]({{% ref "/docs/v1.1/operations/configuration/components" %}}) for details on overriding component parameters.
