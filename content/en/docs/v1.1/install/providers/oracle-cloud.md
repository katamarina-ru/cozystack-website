...
weight: 25
aliases:
  - /docs/v1.1/operations/talos/installation/oracle-cloud
  - /docs/v1.1/talos/install/oracle-cloud
---
...
[installing Cozystack itself]({{% ref "/docs/v1.1/getting-started/install-cozystack" %}}).
...
[Cozystack cluster requirements]({{% ref "/docs/v1.1/install/hardware-requirements" %}}).
