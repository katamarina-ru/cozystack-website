...
Cozystack administrators and users create tenants using the [Tenant application]({{% ref "/docs/v1.1/applications/tenant" %}})
...
Tenants may have [cluster services]({{% ref "/docs/v1.1/operations/services" %}}) deployed in them.
...
- [Tenant Kubernetes cluster]({{% ref "/docs/v1.1/kubernetes" %}}) and a
  [Postgres database]({{% ref "/docs/v1.1/applications/postgres" %}}) in the tenant `bar`.
...
See the reference for the application implementing tenant management: [`tenant`]({{% ref "/docs/v1.1/applications/tenant#parameters" %}})
