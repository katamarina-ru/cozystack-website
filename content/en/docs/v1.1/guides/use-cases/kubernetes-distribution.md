...
weight: 30
aliases:
  - /docs/v1.1/use-cases/kubernetes-distribution
---
...
For a step-by-step guide, see the [BYOP installation guide]({{% ref "/docs/v1.1/install/cozystack/kubernetes-distribution" %}}).
