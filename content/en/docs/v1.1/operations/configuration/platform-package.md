...
weight: 10
aliases:
  - /docs/v1.1/install/cozystack/configmap
  - /docs/v1.1/operations/configuration/configmap
---
...
This Package includes the [Cozystack variant]({{% ref "/docs/v1.1/operations/configuration/variants" %}}) and [component settings]({{% ref "/docs/v1.1/operations/configuration/components" %}}),
...
| Value | Default | Description |
| --- | --- | --- |
| `branding` | `{}` | UI branding configuration object. See the [White Labeling]({{% ref "/docs/v1.1/operations/configuration/white-labeling" %}}) guide for available fields and usage. Individual fields (e.g., `titleText`, `logoSvg`) have their own defaults when not specified. |
...
[enable-disable]: {{% ref "/docs/v1.1/operations/configuration/components#enabling-and-disabling-components" %}}
[overwrite-parameters]: {{% ref "/docs/v1.1/operations/configuration/components#overwriting-component-parameters" %}}
[Resource Management]: {{% ref "/docs/v1.1/guides/resource-management#cpu-allocation-ratio" %}}
[oidc]: {{% ref "/docs/v1.1/operations/oidc" %}}
[telemetry]: {{% ref "/docs/v1.1/operations/configuration/telemetry" %}}
