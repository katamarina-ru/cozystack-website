...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.1/operations/services/seaweedfs" %}}) -- full parameter reference
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.1/operations/stretched/seaweedfs-multidc" %}}) -- multi-DC deployment guide
