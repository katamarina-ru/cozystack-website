...
If you used [Talm]({{% ref "/docs/v1.1/install/kubernetes/talm" %}}) to bootstrap your cluster, your node configurations are stored in `nodes/*.yaml` files in your cluster configuration directory.
...
- [Using Talm to Bootstrap Cozystack]({{% ref "/docs/v1.1/install/kubernetes/talm" %}})
- [Configuring a Dedicated Network for LINSTOR]({{% ref "/docs/v1.1/storage/dedicated-network" %}})
- [Configuring DRBD Resync Controller]({{% ref "/docs/v1.1/storage/drbd-tuning" %}})
- [LINSTOR Troubleshooting]({{% ref "/docs/v1.1/operations/troubleshooting/linstor-controller" %}})
