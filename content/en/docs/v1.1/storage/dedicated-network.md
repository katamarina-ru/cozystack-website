...
weight: 10
aliases:
  - /docs/v1.1/operations/storage/dedicated-network
---
...
See the example in
[Multi Datacenter dedicated storage network guide]({{% ref "/docs/v1.1/operations/stretched/linstor-dedicated-network" %}})
