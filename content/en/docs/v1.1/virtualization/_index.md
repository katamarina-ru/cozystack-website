...
weight: 50
aliases:
  - /docs/v1.1/operations/virtualization
  - /docs/v1.1/operations/virtualization/virtual-machines
---
...
See the application reference: [`vm-disk`]({{% ref "/docs/v1.1/virtualization/vm-disk" %}}).
...
See the application reference: [`vm-instance`]({{% ref "/docs/v1.1/virtualization/vm-instance" %}}).
