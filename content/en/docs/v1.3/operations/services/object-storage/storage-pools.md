...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.3/operations/services/seaweedfs" %}}) -- полный справочник параметров
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.3/operations/stretched/seaweedfs-multidc" %}}) -- руководство по multi-DC развертыванию
