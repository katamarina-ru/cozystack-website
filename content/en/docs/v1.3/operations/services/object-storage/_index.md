...
- [SeaweedFS Service Reference]({{% ref "/docs/v1.3/operations/services/seaweedfs" %}}) -- autogenerated parameter table для SeaweedFS package
- [SeaweedFS Multi-DC Configuration]({{% ref "/docs/v1.3/operations/stretched/seaweedfs-multidc" %}}) -- развертывание SeaweedFS в нескольких дата-центрах
