...
См. [устранение неполадок установки Kubernetes]({{% ref "/docs/v1.3/install/kubernetes/troubleshooting" %}}).

### Обслуживание кластера

#### Удаление отказавшего узла из кластера

См. [Обслуживание кластера > Масштабирование кластера]({{% ref "/docs/v1.3/operations/cluster/scaling" %}}).

### Flux CD

[Устранение неполадок Flux CD]({{% ref "/docs/v1.3/operations/troubleshooting/flux-cd" %}}).

### Kube-OVN

[Устранение неполадок Kube-OVN]({{% ref "/docs/v1.3/operations/troubleshooting/kube-ovn" %}}).
