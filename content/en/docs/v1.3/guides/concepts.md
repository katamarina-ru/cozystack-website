...
Подробнее: [Tenant System]({{% ref "/docs/v1.3/guides/tenants" %}}).
...
Подробнее: [tenant Kubernetes clusters]({{% ref "/docs/v1.3/kubernetes" %}}).
...
Подробнее: [managed applications]({{% ref "/docs/v1.3/applications" %}}).
...
Подробнее: [Cozystack API]({{% ref "/docs/v1.3/cozystack-api" %}}).
...
Подробнее: [Variants]({{% ref "/docs/v1.3/operations/configuration/variants" %}}).
