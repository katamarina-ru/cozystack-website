...
Шаги ручной установки без Ansible см. в руководстве [Generic Kubernetes]({{% ref "/docs/v1.3/install/kubernetes/generic" %}}).
...
- Требования к CPU, RAM и дискам см. в [требованиях к оборудованию]({{% ref "/docs/v1.3/install/hardware-requirements" %}})
