...
Теперь для продолжения установки следуйте руководству **Get Started**, начиная с раздела [**Установка Cozystack**]({{% ref "/docs/v1.3/getting-started/install-cozystack" %}}).
