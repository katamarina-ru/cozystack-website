...
[установке самого Cozystack]({{% ref "/docs/v1.3/getting-started/install-cozystack" %}}).
...
[требованиям к кластеру Cozystack]({{% ref "/docs/v1.3/install/hardware-requirements" %}}).
