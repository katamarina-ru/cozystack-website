...
Для новых production-развертываний рекомендуется [Talos Linux]({{% ref "/docs/v1.3/guides/talos" %}}) благодаря его преимуществам в безопасности и эксплуатации.
...
- **Оборудование**: см. [требования к оборудованию]({{% ref "/docs/v1.3/install/hardware-requirements" %}})
...
1. [Настройте хранилище с LINSTOR]({{% ref "/docs/v1.3/getting-started/install-cozystack#3-configure-storage" %}})
2. [Настройте root tenant]({{% ref "/docs/v1.3/getting-started/install-cozystack#51-setup-root-tenant-services" %}})
3. [Разверните первое приложение]({{% ref "/docs/v1.3/applications" %}})
