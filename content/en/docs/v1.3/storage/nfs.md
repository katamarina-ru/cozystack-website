...
weight: 30
aliases:
  - /docs/v1.3/operations/storage/nfs
---

## Enable NFS driver

Add `cozystack.nfs-driver` to `bundles.enabledPackages` in the [Platform Package]({{% ref "/docs/v1.3/operations/configuration/platform-package" %}}):
