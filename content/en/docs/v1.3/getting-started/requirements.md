...
Более подробное описание требований к оборудованию для разных сценариев см. в разделе [Требования к оборудованию]({{% ref "/docs/v1.3/install/hardware-requirements" %}})
